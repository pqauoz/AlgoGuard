...
*Prepared as the review-first deliverable for the packets/real-time refactor. Once approved, Phase 0–1 can start immediately; nothing in this plan modifies the deployed model or its quality gate.*
